...
| 阶段 | 目录 | 代表能力 | 当前状态 |
|------|------|---------|---------|
| 元能力 | `00-meta/` | 思考教练、系统思维、设计评审 | `systems-design-advisor` 已实现 |
...
1. `00-meta/thinking-coach`
2. `01-discover/user-research`
3. `01-discover/problem-framing`
4. `02-define/information-architecture`
5. `03-design/interaction-design`
6. `04-validate/usability-testing`
